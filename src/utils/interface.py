...
class Information:
    ...
    def from_dict(cls, info_dict):
        """Create a Information object from a dictionary.
           Usage: info = Information.from_dict(info_dict)
...
class KnowledgeExplorationModule(ABC):
    """
...
class OutlineGenerationModule(ABC):
    ...
    def generate_outline(
        ...
        Generate outline for the article. Required arguments include:
            ...
            information_table: knowledge curation data generated from KnowledgeExplorationModule
